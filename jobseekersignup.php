...
<html lang="en">
    ...
    <main class="employer">
      <div>
        <div class="employerform">
          ...
          <div class="employerstep jobseeker">
            <span class="employerstepnumber">Step 1</span>
            <div class="whiteline">
              <div class="greenline"></div>
            </div>
            <span>Please enter your Account details</span>
          </div>
          <div class="employerforms jobseekerforms">
            ...
            <form class="employerform employerform2" action="">
              <label for="code">Please enter the code sent to your email*</label>
              <input id="code" name="code" type="text">
            </form>
            <form class="employerform employerform3" action="">
            ...
            <form class="employerform employerform4" action="">
            ...
            <form enctype="multipart/form-data" class="employerform employerform5" action="">
              <label for="uploadcv">Upload Your CV*</label>
              <input accept=".pdf" id="uploadcv" name="uploadcv" style="border: 0px; color:white; margin-top:10px" type="file">
              <label for="uploadpicture">Upload a Picture of Yourself*</label>
              <input accept=".png" id="uploadpicture" name="uploadpicture" style="border: 0px; color:white; margin-top:10px" type="file">
            </form>
            <button>Next</button>
          </div>
          <span class="haveaccount">Already have an account? <a href="">Sign in</a></span>
        </div>
        <div class="testimonials">
          ...
          <div class="testimonialslide">
            <div class="testimonialcur testimonial1">
              ...
              <p>"Searching and finding your dream job is now easier than ever. Just browse a job and apply if you need to."</p>
              <h3>Mas Parjono</h3>
              <h4>UI Designer at Pierre Lorren</h4>
            </div>
            <div class="testimonial2">
              <img src="./assets/apostrophe.svg" alt="Apostrophe image">
              <p>"Landing your ideal job has never been simpler. Explore available positions and submit your application with just a few clicks."</p>
              <h3>Jenny Jameson</h3>
              <h4>DevOps Engineer at MK Cinemas</h4>
            </div>
            <div class="testimonial3">
              <img src="./assets/apostrophe.svg" alt="Apostrophe image">
              <p>"Finding the perfect career opportunity is now effortless. Browse job listings and apply instantly to start your journey."</p>
              <h3>Ronald McDonald</h3>
              <h4>Full Stack Developer at Dreitzler Enterprises</h4>
            </div>
          </div>
  ...
  <script src="./jobseekersignup.js"></script>
</html>
