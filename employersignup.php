...
<html lang="en">
      ...
      <div>
        <div class="employerform">
          ...
          <div class="employerforms jobseekerforms">
            ...
            <form class="employerform employerform5" action="">
              <label for="">Tell me about your company*</label>
              <textarea id="aboutcompany" name="aboutcompany" type="text" style="height: 150px; width: 100%; margin-top:15px; padding: 10px; border-radius: 10px"></textarea>
            </form>
            <form class="employerform employerform6" action="">
              <label for="">Describe your ideal employee. Please include how much work experience he should have, and necessary skills.*</label>
              <textarea id="aboutemployee" name="aboutemployee" type="text" style="height: 130px; width: 100%; margin-top:15px; padding: 10px; border-radius: 10px"></textarea>
            </form>
            <button>Next</button>
          </div>
  ...
  <script src="./employersignup.js"></script>
</html>
